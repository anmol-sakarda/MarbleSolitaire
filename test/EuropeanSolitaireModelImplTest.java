...
/**
 * Class for testing an European Marble Solitaire Game.
 */
public class EuropeanSolitaireModelImplTest {
  MarbleSolitaireModel exampleOne = new EuropeanSolitaireModelImpl();
  MarbleSolitaireModel exampleTwo = new EuropeanSolitaireModelImpl(5);
  MarbleSolitaireModel exampleThree = new EuropeanSolitaireModelImpl(4, 6);
  MarbleSolitaireModel exampleFour = new EuropeanSolitaireModelImpl(5, 5, 5);
  MarbleSolitaireModel exampleFive = new EuropeanSolitaireModelImpl(0, 2);
  ...
  public void testBuildingDefaultGameMoved() {
    assertEquals(36, this.exampleOne.getScore());
    this.exampleOne.move(3, 1, 3, 3);
    assertEquals(35, this.exampleOne.getScore());
    assertEquals("    O O O\n" +
                    "  O O O O O\n" +
                    "O O O O O O O\n" +
                    "O _ _ O O O O\n" +
    ...
    assertEquals(34, this.exampleOne.getScore());
    assertEquals("    O O O\n" +
                    "  O O O O O\n" +
                    "O O O O O O O\n" +
                    "O _ O _ _ O O\n" +
  ...
  public void testBuildingWithArmThicknessMoved() {
    assertEquals(128, this.exampleTwo.getScore());
    this.exampleTwo.move(6, 4, 6, 6);
    assertEquals(127, this.exampleTwo.getScore());
    assertEquals("        O O O O O\n" +
                    "      O O O O O O O\n" +
                    "    O O O O O O O O O\n" +
                    "  O O O O O O O O O O O\n" +
    ...
    assertEquals(126, this.exampleTwo.getScore());
    assertEquals("        O O O O O\n" +
                    "      O O O O O O O\n" +
                    "    O O O O O O O O O\n" +
                    "  O O O O O O O O O O O\n" +
  ...
  public void testBuildingGameGivenEmptyCoordsMoved() {
    assertEquals(36, this.exampleThree.getScore());
    this.exampleThree.move(4, 4, 4, 6);
    assertEquals(35, this.exampleThree.getScore());
    assertEquals("    O O O\n" +
                    "  O O O O O\n" +
                    "O O O O O O O\n" +
                    "O O O O O O O\n" +
    ...
    assertEquals(34, this.exampleThree.getScore());
    assertEquals("    O O O\n" +
                    "  O O O O O\n" +
                    "O O O O O O O\n" +
                    "O O O O O O O\n" +
  ...
  public void testBuildingAllArgumentsMoved() {
    assertEquals(128, this.exampleFour.getScore());
    this.exampleFour.move(5, 3, 5, 5);
    assertEquals(127, this.exampleFour.getScore());
    assertEquals("        O O O O O\n" +
                    "      O O O O O O O\n" +
                    "    O O O O O O O O O\n" +
                    "  O O O O O O O O O O O\n" +
    ...
    assertEquals(126, this.exampleFour.getScore());
    assertEquals("        O O O O O\n" +
                    "      O O O O O O O\n" +
                    "    O O O O O O O O O\n" +
                    "  O O O O O O O O O O O\n" +
  ...
  public void testNegativeInputTotalConstructor() {
    new EuropeanSolitaireModelImpl(-1, 5, 4);
  }
  ...
  public void testTooBigInputCoordConstructor() {
    new EuropeanSolitaireModelImpl(9, 3);
  }
  ...
  public void testTooBigAllInputBigConstructor() {
    new EuropeanSolitaireModelImpl(3, 8, 4);
  }
  ...
  @Test
  public void testGameOverLostManyMarbles() {
  ...
  public void testGameOver1LeftButNotCenter() {
    ...
    assertEquals("    _ O _\n" +
            ...
            "_ _ _ _ _ _ _\n" +
            "  O _ _ _ O\n" +
            "    _ _ _", this.exampleOne.getGameState());
    assertEquals(true, this.exampleOne.isGameOver());
  }
  ...
  public void testGameWon() {
    // 2 2 0 2 2 0 2 2 1 4 1 2 3 4 1 4 3 2 3 4 2 3 2 1 5 3 3 3 3 0 3 2 5 1 3 1 4 5 4 3 5 5 5 3
    // 0 4 2 4 2 1 4 1 2 4 4 4 5 2 5 4 3 6 3 4 1 1 1 3 2 6 2 4 0 3 2 3 3 2 5 2 3 4 3 2 6 2 4 2
    // 3 2 5 2 4 0 4 2 4 3 4 1 6 4 6 2 6 2 4 2 4 1 4 3 4 3 4 5 4 6 4 4 5 4 3 4 3 4 1 4 1 5 1 3 2
    // 3 0 3 0 2 0 4
    this.exampleFive.move(2, 2, 0, 2);
    this.exampleFive.move(2, 0, 2, 2);
    this.exampleFive.move(1, 4, 1, 2);
    this.exampleFive.move(3, 4, 1, 4);
    this.exampleFive.move(3, 2, 3, 4);
    this.exampleFive.move(2, 3, 2, 1);
    this.exampleFive.move(5, 3, 3, 3);
    this.exampleFive.move(3, 0, 3, 2);
    this.exampleFive.move(5, 1, 3, 1);
    this.exampleFive.move(4, 5, 4, 3);
    this.exampleFive.move(5, 5, 5, 3);
    this.exampleFive.move(0, 4, 2, 4);
    this.exampleFive.move(2, 1, 4, 1);
    this.exampleFive.move(2, 4, 4, 4);
    this.exampleFive.move(5, 2, 5, 4);
    this.exampleFive.move(3, 6, 3, 4);
    this.exampleFive.move(1, 1, 1, 3);
    this.exampleFive.move(2, 6, 2, 4);
    this.exampleFive.move(0, 3, 2, 3);
    this.exampleFive.move(3, 2, 5, 2);
    this.exampleFive.move(3, 4, 3, 2);
    this.exampleFive.move(6, 2, 4, 2);
    this.exampleFive.move(3, 2, 5, 2);
    this.exampleFive.move(4, 0, 4, 2);
    this.exampleFive.move(4, 3, 4, 1);
    this.exampleFive.move(6, 4, 6, 2);
    this.exampleFive.move(6, 2, 4, 2);
    this.exampleFive.move(4, 1, 4, 3);
    this.exampleFive.move(4, 3, 4, 5);
    this.exampleFive.move(4, 6, 4, 4);
    this.exampleFive.move(5, 4, 3, 4);
    this.exampleFive.move(3, 4, 1, 4);
    this.exampleFive.move(1, 5, 1, 3);
    this.exampleFive.move(2, 3, 0, 3);
    this.exampleFive.move(0, 2, 0, 4);


    assertEquals(true, this.exampleFive.isGameOver());
  }
}
